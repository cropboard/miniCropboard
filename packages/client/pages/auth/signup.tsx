...
const SignUpPage: FunctionComponent = (): JSX.Element => {
  ...
  async function registerUser(event: any): Promise<void> {
    ...
    if (
      ...
      registrationStatus = await signupHandler(
        SERVER_,
        name.trim(),
    ...
    <div>
      ...
      <section className={styles.registrationFormContainer}>
        ...
        >
          ...
          <input
            value={name}
            onChange={(event) => handleTextFieldChange(event, setName)}
            type="text"
            placeholder="Name"
          />
          <input
          ...
          <input
            ...
            onChange={(event) =>
              handleTextFieldChange(event, setConfirmPassword)
            }
            type="password"
          ...
          {chechIsSamePassowrd() ? (
            <p
              style={{ color: "rgb(118, 252, 118)", fontFamily: "sans-serif" }}
            >
              Passwords Match
            </p>
          ) : (
            <p style={{ color: "rgb(255 59 59)", fontFamily: "sans-serif" }}>
              {" "}
          ...
          <input
            value={location}
            onChange={(event) => handleTextFieldChange(event, setLocation)}
            type="text"
            placeholder="Country"
          />
